...
const validationSchema = Yup.object().shape({
  ...
  identifyingMemberName: Yup.string().required('Identifying Member Name is required'),
  identifyingMemberAddress: Yup.string().required('Identifying Member Address is required'),
});
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    <Field
                      ...
                      helperText={<ErrorMessage name="identifyingMemberAddress" />}
                    />
                  </Grid>
                  {/* <Grid item xs={12}>
                    <Field
